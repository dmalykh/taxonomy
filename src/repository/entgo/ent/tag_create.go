...
func (tc *TagCreate) SetNillableTitle(s *string) *TagCreate {
	if s != nil {
		tc.SetTitle(*s)
	}
	return tc
...
func (tc *TagCreate) SetCategoryID(i int) *TagCreate {
	tc.mutation.SetCategoryID(i)
	return tc
}

// SetCategory sets the "category" edge to the Category entity.
func (tc *TagCreate) SetCategory(c *Category) *TagCreate {
...
func (tc *TagCreate) check() error {
	...
	if v, ok := tc.mutation.CategoryID(); ok {
	...
	if _, ok := tc.mutation.CategoryID(); !ok {
		return &ValidationError{Name: "category", err: errors.New(`ent: missing required edge "Tag.category"`)}
	}
	return nil
}
