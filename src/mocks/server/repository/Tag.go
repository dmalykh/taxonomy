...
func (_m *Tag) DeleteById(ctx context.Context, id uint64) error {
...
func (_m *Tag) GetByFilter(ctx context.Context, filter model.TagFilter, limit uint64, offset uint64) ([]model.Tag, error) {
	ret := _m.Called(ctx, filter, limit, offset)

	var r0 []model.Tag
	if rf, ok := ret.Get(0).(func(context.Context, model.TagFilter, uint64, uint64) []model.Tag); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, model.TagFilter, uint64, uint64) error); ok {
