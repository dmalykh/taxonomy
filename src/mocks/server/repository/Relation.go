...
func (_m *Relation) Delete(ctx context.Context, filter *model.Relation) error {
...
func (_m *Relation) Get(ctx context.Context, tagIds []uint64, namespaceIds []uint64, entityIds []uint64) ([]model.Relation, error) {
	ret := _m.Called(ctx, tagIds, namespaceIds, entityIds)

	var r0 []model.Relation
	if rf, ok := ret.Get(0).(func(context.Context, []uint64, []uint64, []uint64) []model.Relation); ok {
