...
func (_m *Namespace) Delete(ctx context.Context, uid uint64) error {
...
func (_m *Namespace) Update(ctx context.Context, uid uint64, name string) (model.Namespace, error) {
